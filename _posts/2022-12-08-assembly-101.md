...
Diğer registerların aksine hafıza adresi üretmek/saklamak için kullanılan registerlardır. Bir önceki yazıdaki **"Section"** kısımlarına benzer yapıları vardır. [Bkz. PE 101](2022-12-05-pe-mimarisi.md).
...
# Fonksiyon Çağrımları ve Stack Yapısı
