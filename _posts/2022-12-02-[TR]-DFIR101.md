---
title: Çalışan Uygulama Kalıntıları
language: TR
published: true
category: DFIR
---
...
![Program](../assets/program-kalıntıları.png)
...
![ShimcacheParser Çıktı](../assets/shimcache-parser-output.png)
...
program-kalıntıları.png
user-assist.png
recentapps.png
ftk-shimcache.png
shimcache.png
shimcache-parser-usage.png
shimcache-parser-output.png
pe-cmd-output.png
mru-open-save.png
mru-last-regedit.png
mru-regedit.png
lnk.png
lnk-cmd.png